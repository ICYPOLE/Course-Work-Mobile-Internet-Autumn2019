...
contract Users {
  ...
  function exists (address _address) public returns (bool _exists) {
    return (users[_address] != bytes32(0));
  }

  function authenticate () public returns (bytes32 _pseudo) {
  ...
  function get (address _address) public returns(bytes32 _pseudo) {
